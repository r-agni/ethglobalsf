...
const Getstarted = () => {
    return (
        ...
        <div className="relative w-full min-h-screen bg-gradient-to-b from-skyblue-500 to-cyan-200">
            {/* Navigation Bar */}
            <NavBar />
            <div className="absolute inset-0 bg-gradient-to-br from-skyblue-100 to-cyan-50"></div>
            {/* Top Half */}
            <div className="relative z-10 p-8 bg-white rounded-b-lg shadow-lg flex flex-col items-center justify-center h-1/2">
                <h1 className="text-4xl font-bold text-center mb-4 text-skyblue-900">Get Started</h1>
                <p className="text-lg text-center text-gray-600 mb-8 max-w-3xl mx-auto">
                    Choose the type of account you want to create.
                </p>
            </div>
            {/* Bottom Half */}
            <div className="relative z-10 mt-8 p-4 rounded-t-lg bg-gradient-to-b from-skyblue-200 to-cyan-300 h-1/2 flex flex-wrap justify-center gap-4">
