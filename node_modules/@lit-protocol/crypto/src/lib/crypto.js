...
exports.checkSevSnpAttestation = exports.generateSessionKeyPair = exports.computeHDPubKey = exports.combineEcdsaShares = exports.verifySignature = exports.combineSignatureShares = exports.verifyAndDecryptWithSignatureShares = exports.decryptWithSignatureShares = exports.encrypt = exports.unloadModules = exports.loadModules = void 0;
...
*/
const unloadModules = () => {
    (0, misc_1.log)('running cleanup for global modules');
    if (globalThis.wasmExports)
...
const combineEcdsaShares = (sigShares) => {
    ...
    try {
        let res = '';
        switch (type) {
            case constants_2.LIT_CURVE.EcdsaCaitSith:
            case constants_2.LIT_CURVE.EcdsaK256:
                ...
                */
                ...
                break;
            case constants_2.LIT_CURVE.ECDSCAITSITHP256:
