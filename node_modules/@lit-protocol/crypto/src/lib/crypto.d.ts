...
*/
export declare const loadModules: () => Promise<void>;
export declare const unloadModules: () => void;
/**
...
export declare const computeHDPubKey: (pubkeys: string[], keyId: string, sigType: LIT_CURVE) => string;
/**
 *
