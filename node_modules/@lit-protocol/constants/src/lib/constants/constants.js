...
exports.metamaskChainInfo = {
     ...
     */
    chronicle: {
        chainId: exports.LIT_CHAINS['chronicleTestnet'].chainId,
        chainName: exports.LIT_CHAINS['chronicleTestnet'].name,
        nativeCurrency: {
            name: exports.LIT_CHAINS['chronicleTestnet'].symbol,
            symbol: exports.LIT_CHAINS['chronicleTestnet'].symbol,
            decimals: exports.LIT_CHAINS['chronicleTestnet'].decimals,
        },
        rpcUrls: exports.LIT_CHAINS['chronicleTestnet'].rpcUrls,
        blockExplorerUrls: exports.LIT_CHAINS['chronicleTestnet'].blockExplorerUrls,
        iconUrls: ['future'],
    },
    /**
...
exports.RPC_URL_BY_NETWORK = {
    cayenne: exports.LIT_RPC.CHRONICLE,
    manzano: exports.LIT_RPC.CHRONICLE,
    habanero: exports.LIT_RPC.CHRONICLE,
...
exports.METAMASK_CHAIN_INFO_BY_NETWORK = {
    cayenne: exports.metamaskChainInfo.chronicle,
    manzano: exports.metamaskChainInfo.chronicle,
    habanero: exports.metamaskChainInfo.chronicle,
    'datil-dev': exports.metamaskChainInfo.yellowstone,
    'datil-test': exports.metamaskChainInfo.yellowstone,
    datil: exports.metamaskChainInfo.yellowstone,
 ...
 */
exports.RELAY_URL_DATIL_DEV = 'https://datil-dev-relayer.getlit.dev';
/**
 * @deprecated Will be removed in version 7.x. - Use RELAYER_URL_BY_NETWORK.DatilTest instead
 */
exports.RELAY_URL_DATIL_TEST = 'https://datil-test-relayer.getlit.dev';
// ========== Lit Actions ==========
