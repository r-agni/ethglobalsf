    ...
    `);
        ...
        this.checkNeedToResignSessionKey = async ({ authSig, sessionKeyUri, resourceAbilityRequests, }) => {
            ...
            if (authSig.algo === `ed25519` || authSig.algo === undefined) {
                ...
                try {
                    (0, validate_bls_session_sig_1.blsSessionSigVerify)(blsSdk.verify_signature, this.networkPubKey, authSig, authSigSiweMessage);
                }
                catch (e) {
        ...
        this.decrypt = async (params) => {
            ...
            // ========== Result ==========
            const decryptedData = this._decryptWithSignatureShares(this.subnetPubKey, (0, uint8arrays_1.uint8arrayFromString)(identityParam, 'utf8'), ciphertext, signatureShares);
