import { CreateCustomAuthMethodRequest, EpochInfo, GasLimitParam, LIT_NETWORKS_KEYS, LitContractContext, LitContractResolverContext, MintCapacityCreditsContext, MintCapacityCreditsRes, MintNextAndAddAuthMethods, MintWithAuthParams, MintWithAuthResponse } from '@lit-protocol/types';
...
import { AuthMethodScope, AuthMethodType, HTTP, HTTPS } from '@lit-protocol/constants';
...
export declare class LitContracts {
    ...
    static getConnectionInfo: ({ litNetwork, networkContext, rpcUrl, nodeProtocol, }: {
        ...
        networkContext?: LitContractContext | LitContractResolverContext | undefined;
        rpcUrl?: string | undefined;
        nodeProtocol?: "http://" | "https://" | null | undefined;
    }) => Promise<{
