...
import { DecryptRequest, DecryptZipFileWithMetadata, DecryptZipFileWithMetadataProps, EncryptFileAndZipWithMetadataProps, EncryptFileRequest, EncryptResponse, EncryptStringRequest, EncryptZipRequest, IJWT, ILitNodeClient, SigningAccessControlConditionJWTPayload, VerifyJWTProps, EncryptToJsonProps, DecryptFromJsonProps } from '@lit-protocol/types';
/**
 ...
 *
 */
export declare function decryptFromJson<T extends DecryptFromJsonProps>(params: T): Promise<T extends {
    parsedJsonData: {
        dataType: 'file';
    };
...
*/
export declare const zipAndEncryptFiles: (files: File[], params: DecryptRequest, litNodeClient: ILitNodeClient) => Promise<EncryptResponse>;
/**
 *
 ...
 */
export declare const decryptToZip: (params: DecryptRequest, litNodeClient: ILitNodeClient) => Promise<Record<string, JSZip.JSZipObject>>;
/**
 *
