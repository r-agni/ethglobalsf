...
const NETWORKS_REQUIRING_SEV = [
    constants_1.LitNetwork.Habanero,
    constants_1.LitNetwork.Manzano,
    constants_1.LitNetwork.DatilTest,
    constants_1.LitNetwork.Datil,
];
/**
...
class LitCore {
    ...
    constructor(config) {
        ...
        if (!(config.litNetwork in constants_1.LIT_NETWORKS)) {
            const supportedNetwork = Object.values(constants_1.LIT_NETWORK).join(', ');
            return (0, misc_1.throwError)({
        ...
        switch (config?.litNetwork) {
            ...
            case constants_1.LitNetwork.DatilDev:
        ...
        (0, misc_1.bootstrapLogManager)('core', this.config.debug ? logger_1.LogLevel.DEBUG : logger_1.LogLevel.OFF);
